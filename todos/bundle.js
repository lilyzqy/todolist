...
var removeTodo = exports.removeTodo = function removeTodo(todoId) {
  return {
    type: REMOVE_TODO,
    todoId: todoId
  };
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Provider__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_connectAdvanced__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__connect_connect__ = __webpack_require__(163);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_invariant__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_invariant___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_invariant__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_Subscription__ = __webpack_require__(162);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(58);
...
var allTodos = exports.allTodos = function allTodos(state) {
  return Object.keys(state.todos).map(function (todoId) {
    return state.todos[todoId];
  });
};
var allSteps = exports.allSteps = function allSteps(state) {
  return Object.keys(state.steps).map(function (stepListId) {
    return state.steps[stepListId];
  });
};
...
var _todo_actions = __webpack_require__(22);

var _root = __webpack_require__(156);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var m=__webpack_require__(5),n=__webpack_require__(8),p=__webpack_require__(2);
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(28),A=__webpack_require__(5),B=__webpack_require__(2),ca=__webpack_require__(29),da=__webpack_require__(30),ea=__webpack_require__(31),ha=__webpack_require__(32),ia=__webpack_require__(33),C=__webpack_require__(8);
...
var _root_reducer = __webpack_require__(87);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(21), __webpack_require__(10)(module)))
...
var _todosReducer = __webpack_require__(88);

var _todosReducer2 = _interopRequireDefault(_todosReducer);

var _steps_reducer = __webpack_require__(181);
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    ...
    case _todo_actions.REMOVE_TODO:
      var newSt = (0, _merge2.default)({}, state);
...
var Stack = __webpack_require__(91),
    assignMergeValue = __webpack_require__(41),
...
var assignMergeValue = __webpack_require__(41),
    ...
    toPlainObject = __webpack_require__(140);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_shallowEqual__ = __webpack_require__(164);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapDispatchToProps__ = __webpack_require__(165);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mapStateToProps__ = __webpack_require__(166);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mergeProps__ = __webpack_require__(167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__selectorFactory__ = __webpack_require__(168);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wrapMapToProps__ = __webpack_require__(57);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wrapMapToProps__ = __webpack_require__(57);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(169);
function _objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }
...
var _todo_list_container = __webpack_require__(171);
...
var _todo_list = __webpack_require__(172);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    removeTodo: function removeTodo(todoId) {
      return dispatch((0, _todo_actions.removeTodo)(todoId));
    }
  };
};
...
var _todo_list_item = __webpack_require__(173);

var _todo_list_item2 = _interopRequireDefault(_todo_list_item);

var _todo_form = __webpack_require__(174);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          todos.map(function (todo) {
            return _react2.default.createElement(_todo_list_item2.default, { key: todo.id, todo: todo, removeTodo: removeTodo });
          })
        ),
...
var TodoListItem = function (_React$Component) {
  ...
  function TodoListItem(props) {
    ...
    var _this = _possibleConstructorReturn(this, (TodoListItem.__proto__ || Object.getPrototypeOf(TodoListItem)).call(this));
    //debugger
  ...
  _createClass(TodoListItem, [{
    ...
    value: function showDetail() {
      if (this.state.detail) {
        return _react2.default.createElement(_todo_detail_view_container2.default, { todo: this.props.todo });
      }
    }
  }, {
    key: 'changeDetail',
    value: function changeDetail() {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h2',
          { onClick: this.changeDetail.bind(this) },
          this.props.todo.title
        ),
        _react2.default.createElement(
          'button',
          { type: 'button', onClick: this.updateTodo },
          ' ',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          "Title",
          _react2.default.createElement("input", { type: "text", name: "title", onChange: this.changeState })
        ),
        _react2.default.createElement(
          "label",
          null,
          "Body",
          _react2.default.createElement("textarea", { name: "body", onChange: this.changeState })
        ),
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          "Description",
          _react2.default.createElement("input", { type: "text", name: "description", onChange: this.changeState })
        ),
        _react2.default.createElement(
          "button",
...
var _step_actions = __webpack_require__(180);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    receiveSteps: function receiveSteps(steps) {
      return dispatch((0, _step_actions.receiveSteps)(steps));
    },
...
var _step_form = __webpack_require__(176);

var _step_form2 = _interopRequireDefault(_step_form);

var _step_list_container = __webpack_require__(182);
...
var TodoDetailView = function (_React$Component) {
  ...
  function TodoDetailView(props) {
    ...
    var _this = _possibleConstructorReturn(this, (TodoDetailView.__proto__ || Object.getPrototypeOf(TodoDetailView)).call(this));
  ...
  _createClass(TodoDetailView, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_step_list_container2.default, { todoId: this.props.todo.id }),
        _react2.default.createElement(
          'button',
...
var removeStep = exports.removeStep = function removeStep(stepId) {
  return {
    type: REMOVE_STEP,
    stepId: stepId
  };
...
var stepsReducer = function stepsReducer() {
  ...
  switch (action.type) {
    case _step_actions.RECEIVE_STEP:
      ...
      return (0, _merge2.default)({}, state, newStep);
...
var _step_list = __webpack_require__(183);
...
var mapStateToProps = function mapStateToProps(state, _ref) {
  ...
  debugger;
  return {
    steps: (0, _selectors.allSteps)(state, todoId)
  };
};
  ...
  _createClass(StepList, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          receiveStep = _props.receiveStep,
          steps = _props.steps,
      ...
      return _react2.default.createElement(
        'ul',
        null,
        _react2.default.createElement(StepListItemContainer, { todoId: this.props.todoId })
      );
    }
  }]);
